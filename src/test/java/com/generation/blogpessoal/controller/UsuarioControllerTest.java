...
public class UsuarioControllerTest {
	...
	void naodeveCadastrarUsuario() {
		//Given
		Usuario usuario = TestBuilder.criarUsuario(null, "Rafaela", "rafaela_lemes@email.com.br", "12345678");
	...
	@Test
	@DisplayName("03 - Deve Atualizar os dados do usuário")
	void DeveAtualizarUsuario() {
		...
		Usuario usuarioUpdate = 
				TestBuilder.criarUsuario(usuarioCadastrado.get().getId(), "Nadia Caricatto",
